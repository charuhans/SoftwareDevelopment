...
//  
    ...
    def setup() {
    _currencyExchange = new converter.CurrencyConverter([])
  }
  ...
  def pickHighestRateAndVendor(vendorNamesAndRates) {
      _currencyExchange.getVendorWithMaxExchangeRate(vendorNamesAndRates)
  }

  def adjustedHighRate(String[] vendorNames) {
    def currencyExchange = 
      new converter.CurrencyConverter(Arrays.asList(vendorNames))
    currencyExchange.getVendorAndExchangeRate("GBP")
  }
}
